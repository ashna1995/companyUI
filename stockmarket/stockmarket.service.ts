...
export class StockmarketService {
  ...
  constructor(private http:HttpClient)
   ...
   private apiGet:string =`http://localhost:8082/api/v1/market/company/getall`;
   private apiPost:string =`http://localhost:8082/api/v1/market/company/register`;
   private apiDel:string ='http://localhost:8082/api/v1/market/company/delete';
   private apiPutcompany:string ='http://localhost:8082/api/v1/market/updatecompany';
   private apiGetcompany:string ='http://localhost:8082/api/v1/market/company/info';
   private apiPoststock:string ='http://localhost:8082/api/v1/market/stock/add';
   private apiPutstock:string ='http://localhost:8082/api/v1/market/stock/put';
